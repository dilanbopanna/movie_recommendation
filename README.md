...
Step 3 - The final movie reccomandation prediction is done based on a text input bar to add your movie whose recommendation you want. Output will give you top 4 matches that are recommended movies.
